...
desktop-ci: desktop-check desktop-test desktop-tauri-fmt-check desktop-build desktop-tauri-check
...
ci: check test-unit desktop-test desktop-build desktop-tauri-check web-build mobile-test
