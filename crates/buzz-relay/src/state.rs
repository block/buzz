...
pub struct AppState {
    ...
    /// Shared HTTP client for the relay-proxied HiveTalk "Meetings" control
    /// plane. Redirect-disabled so a signed request is never replayed to an
    /// attacker-chosen host.
    pub hivetalk_http_client: reqwest::Client,
...
impl AppState {
    ...
    pub fn new(
        ...
        let hivetalk_http_client = crate::api::meetings::build_hivetalk_http_client();
