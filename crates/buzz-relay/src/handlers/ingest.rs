...
use buzz_core::kind::{
    ...
    KIND_PLANNING_PROJECT, KIND_PLANNING_TASK, KIND_PRESENCE_UPDATE, KIND_PRODUCT_FEEDBACK,
    KIND_PROFILE, KIND_REACTION, KIND_READ_STATE, KIND_REPORT, KIND_STREAM_MESSAGE,
...
fn required_scope_for_kind(kind: u32, event: &Event) -> Result<Scope, &'static str> {
    match kind {
        ...
        | KIND_MISSION_CONSTRAINT | KIND_PERSONA | KIND_TEAM | KIND_MANAGED_AGENT
