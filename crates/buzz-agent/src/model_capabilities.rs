...
mod tests {
    ...
    Q::Section { group: "GPT-6 effort and route compatibility", note: None },
    Q::Vector { id: "openai-gpt6-sol", provider: "openai", raw_model_id: "gpt-6-sol", note: None },
    Q::Vector { id: "openai-gpt6-luna", provider: "openai", raw_model_id: "gpt-6-luna", note: None },
    Q::Vector { id: "openai-gpt6-astra", provider: "openai", raw_model_id: "gpt-6-astra", note: Some("Astra excludes none and minimal while retaining max.") },
    Q::Vector { id: "openai-gpt6-sol2-boundary", provider: "openai", raw_model_id: "gpt-6-sol2", note: Some("Future variant must not inherit Sol's effort table.") },
    Q::Vector { id: "openai-prefixed-gpt6-astra", provider: "openai", raw_model_id: "team-x-gpt-6-astra", note: None },
    Q::Vector { id: "dbv2-gpt6-sol", provider: "databricks_v2", raw_model_id: "goose-gpt-6-sol", note: None },
    Q::Vector { id: "dbv2-gpt6-luna", provider: "databricks_v2", raw_model_id: "gpt-6-luna", note: None },
    Q::Vector { id: "dbv2-gpt6-astra", provider: "databricks_v2", raw_model_id: "databricks-gpt-6-astra", note: None },
    ...
    #[test]
    fn corpus_has_exactly_166_executable_vectors() {
