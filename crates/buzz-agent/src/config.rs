...
mod tests {
    ...
    #[test]
    fn gpt6_effort_normalization_respects_astra_none_boundary() {
        for model in ["gpt-6-sol", "gpt-6-luna"] {
            assert_eq!(
                normalize_effort_for_provider("openai", model, ThinkingEffort::None),
                ThinkingEffort::None
            );
            assert_eq!(
                normalize_effort_for_provider("openai", model, ThinkingEffort::Max),
                ThinkingEffort::Max
            );
        }
        assert_eq!(
            normalize_effort_for_provider("openai", "gpt-6-astra", ThinkingEffort::None),
            ThinkingEffort::Low
        );
        assert_eq!(
            normalize_effort_for_databricks_v2(ThinkingEffort::None, "databricks-gpt-6-astra"),
            ThinkingEffort::Low
        );
        assert_eq!(
            normalize_effort_for_databricks_v2(ThinkingEffort::Max, "databricks-gpt-6-astra"),
            ThinkingEffort::Max
        );
    }
