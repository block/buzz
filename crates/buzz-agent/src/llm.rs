...
pub struct Llm {
    ...
    /// Effective model IDs that have explicitly rejected image input during
    /// this process. Images remain intact in history and are degraded only
    /// while serializing requests for a model in this set.
