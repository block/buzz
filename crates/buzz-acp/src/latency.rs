...
impl LatencyCollector {
    ...
    fn unambiguous_channel_turn(
        ...
        // Flat human-facing replies may point at an older conversation root
        // rather than this turn's trigger. If a completed no-reply turn and a
        // newer active turn overlap, the relay event cannot identify either
        // one safely. Drop that sample instead of manufacturing plausible
        // zeroes or polluting the newer turn.
