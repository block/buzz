...
mod tests {
    use super::{
        ...
        cmd_list_channels, cmd_set_add_policy, fetch_candidate_hints, finalize_roster_resolution,
        format_candidate, hints_from_results, join_bounded_queries, name_matches,
