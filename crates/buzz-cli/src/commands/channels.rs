...
mod tests {
    use super::{
        apply_cardinality_rule, build_template_report, channel_member_profile_filter,
        cmd_set_add_policy, enrich_channel_member_display_names, finalize_roster_resolution,
        name_matches, resolve_roster_with_archive_filter, validate_ttl_seconds,
        validate_update_channel_fields, ArchivedExclusion, ChannelSummary, ResolvedAgent,
        RosterResolution, SkippedSlug,
    };
