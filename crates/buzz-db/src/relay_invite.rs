...
pub async fn mint_relay_invite(
    ...
    let guest_channel_generation = if let Some(channel_id) = guest_channel_id {
        ...
        crate::channel::acquire_channel_membership_lock(&mut tx, community, channel_id).await?;
...
mod tests {
    ...
    async fn guest_claim_serializes_last_owner_check_with_channel_membership_writes() {
        ...
        crate::channel::acquire_channel_membership_lock(&mut holder, community, channel_id)
            .await
    ...
    async fn guest_claim_rechecks_channel_eligibility_after_membership_lock() {
        ...
        crate::channel::acquire_channel_membership_lock(&mut transition, community, channel_id)
            .await
