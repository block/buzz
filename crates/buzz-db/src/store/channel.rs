...
pub(crate) use crate::channel_members::{acquire_channel_membership_lock, membership_revision_tx};
pub use crate::channel_members::{
    add_member, channel_membership_lock_key, get_accessible_channel_ids, get_accessible_channels,
    ...
    lock_member_snapshot, membership_pairs, membership_revision, remove_member,
    verify_channel_roster_fence_behavior, verify_channel_roster_fence_catalog, AccessibleChannel,
    BotChannelEntry, BotMemberRecord, LargeChannelRoster, LockedMemberSnapshot, MemberRecord,
    UserRecord,
};
