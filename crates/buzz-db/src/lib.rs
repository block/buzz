...
impl Db {
    ...
    /// archived (the alias-collision trigger from migration 0028 checks
    ...
    /// raw constraint-violation error; migration 0028's trigger is the
    ...
    /// can't catch that case — migration 0028's `communities_no_alias_collision`
    ...
    /// migration 0028's `communities_no_alias_collision` trigger, which
...
mod tests {
    ...
    /// migration 0028's trigger raise a raw database error.
    #[tokio::test]
    #[ignore = "requires Postgres"]
