...
-- FounderPortal collaboration bridge persistence lives in a separately owned
-- schema. It stores identifiers and convergence state only; core Buzz tables
-- remain free of FounderPortal-specific columns.
CREATE SCHEMA founderportal_bridge;
