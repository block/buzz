...
-- ── Agent job lifecycle projection ───────────────────────────────────────────
-- Public signed kinds 43001-43006 remain the collaboration record. These
-- community-scoped rows provide atomic admission, idempotency, and indexed
-- canonical status without an event-history pre-query.
