...
-- ── Identity handoffs (v3) ───────────────────────────────────────────────────
-- Conformance: bearer codes and link-incarnation values are represented only
-- by domain-specific SHA-256 digests. Revocation fences survive handoff-row
-- retention cleanup and contain no public key.
