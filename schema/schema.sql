...
CREATE TABLE events (
    ...
    -- never matches `@@`.
    -- Keep in sync with migrations (final state: 0001 + 0005 + 0014 + 0033 + 0040 + 0041 + 0042).
    search_tsv  TSVECTOR GENERATED ALWAYS AS (
        CASE WHEN kind IN (1059, 30179, 30300, 30350, 30622, 44100, 44101, 44200, 50000, 50001, 50002) THEN NULL::tsvector
