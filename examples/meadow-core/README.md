...
config; use it as reference to recreate these agents in the desktop app by hand, or wire it up to
`buzz-acp` yourself. See "Desktop App Import" in `crates/buzz-persona/PERSONA_PACK_SPEC.md` for
