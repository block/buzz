...
ci: realtime-audio-test check test-unit desktop-test desktop-build desktop-tauri-check desktop-tauri-test web-build mobile-test
...
# Exercise the dependency-free local Realtime demo.
realtime-audio-test:
