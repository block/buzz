# Contributing to Pkzz

Welcome, and thank you for your interest in contributing! Pkzz is an
open-source project and we're glad you're here. This guide will help you
get from zero to a merged pull request.

If you have questions that aren't answered here, [open an issue](https://github.com/kingkillery/pkzz/issues/new).
...
Before starting, search [open PRs](https://github.com/kingkillery/pkzz/pulls) and [open issues](https://github.com/kingkillery/pkzz/issues) for duplicates — someone may already be working on the same thing. When you open your PR, link the closest existing one in the description (or say "none found").
...
Pkzz is an agent platform, so AI-assisted PRs are welcome. No need to disclose the tools you used, but you own and must have reviewed the final code. Submissions that are clearly unreviewed may be closed with a pointer here.
...
just reset   # Wipe all dev state and recreate it; installed Pkzz is preserved
```
...
Pkzz is developed across multiple repositories. This repo (`kingkillery/pkzz`)
...
Pkzz is licensed under the **Apache License, Version 2.0**. See
...
*Thank you for contributing to Pkzz. Every bug report, documentation fix,
