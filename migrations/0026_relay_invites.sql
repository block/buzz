...
--
-- Downstream note: upstream introduced this as migration 0025, but Command
-- Adviser already shipped 0025_command_brief_fts.sql. Keep applied migration
-- checksums immutable and assign the new, previously unapplied change version
-- 0026 so existing Command Adviser databases can upgrade safely.
--
