...
use commands::*;
use deep_link::{
    acknowledge_pending_agent_install_deep_link, acknowledge_pending_community_deep_link,
    handle_deep_link_url, take_pending_agent_install_deep_link, take_pending_community_deep_link,
    PendingAgentInstallDeepLinks, PendingCommunityDeepLinks,
};
...
pub fn run() {
    ...
    let app = builder
        ...
        .manage(PendingAgentInstallDeepLinks::default())
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            acknowledge_pending_agent_install_deep_link,
