...
pub fn run() {
    ...
    let app = app_menu::install(builder)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            archive::journal_authority_commands::upsert_owner_journal_override,
            archive::journal_authority_commands::upsert_journal_verification,
            archive::journal_authority_commands::get_journal_authority_artifacts,
            archive::journal_authority_commands::query_journal_authority_artifacts,
            archive::journal_authority_commands::write_owner_today_snapshot,
            archive::journal_authority_commands::read_owner_today_snapshot,
