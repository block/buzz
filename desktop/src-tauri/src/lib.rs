...
use huddle::{
    ...
    check_pipeline_hotstart, close_huddle_companion, confirm_huddle_active,
    download_german_speech_models, download_voice_models, end_huddle, get_huddle_agent_pubkeys,
    get_huddle_state, get_model_status, get_voice_input_mode, interrupt_huddle_speech, join_huddle,
    leave_huddle, open_huddle_window, push_audio_pcm, reconnect::reconnect_huddle_audio,
    remove_agent_from_huddle, remove_german_speech_models, set_huddle_manual_mic_unmuted,
...
pub fn run() {
    ...
    let app = app_menu::install(builder)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            download_german_speech_models,
            remove_german_speech_models,
            get_model_status,
            set_tts_enabled,
            ...
            huddle::tts_settings::set_german_voice,
