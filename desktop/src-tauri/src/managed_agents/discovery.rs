...
const KNOWN_ACP_RUNTIMES: &[KnownAcpRuntime] = &[
    KnownAcpRuntime {
        ...
        cli_install_hint: "Zorro talks to Goose through the Goose CLI.",
    ...
    KnownAcpRuntime {
        ...
        cli_install_hint: "Zorro talks to Claude Code through the Claude Code CLI.",
        adapter_install_hint: "Zorro talks to the Claude Code CLI through an ACP adapter. Install it with: npm install -g @agentclientprotocol/claude-agent-acp.",
    ...
    KnownAcpRuntime {
        ...
        cli_install_hint: "Zorro talks to Codex through the Codex CLI.",
        adapter_install_hint: "Zorro talks to the Codex CLI through an ACP adapter. Install it with: npm install -g @agentclientprotocol/codex-acp.",
    ...
    KnownAcpRuntime {
        ...
        cli_install_hint: "Ships with the Zorro desktop app.",
        adapter_install_hint: "",
        skill_dir: None,
