...
const ANGELICA_AVATAR: &str =
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1MGeCxaWcvoonCISYyuhWfjngmSE8cyJhfQ&s";
const BART_AVATAR: &str =
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShI3uwQ-mSgRdv5WYBibPyo2I3X7ybsYmrVQ&s";
const CHUCKY_AVATAR: &str =
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_cxY4ocdqIGx5JVRuZjlCvyhlhEWV5MXWDw&s";
const MARGE_AVATAR: &str = "https://static0.srcdn.com/wordpress/wp-content/uploads/2023/05/the-simpsons-season-34-marge-blue-hair.jpg";
const NED_AVATAR: &str = "https://i1.sndcdn.com/artworks-000362506068-4i6lyp-t500x500.jpg";
const TOMMY_AVATAR: &str = "https://i.redd.it/the-slight-redesigns-of-tommy-pickles-back-in-the-90s-v0-ii3f8rsmv1cf1.jpg?width=1290&format=pjpg&auto=webp&s=e9901c8661d5b3a00e49704d12d02fef87c5947e";
...
const ANGELICA_SYSTEM_PROMPT: &str = r#"You are Angelica. You help turn broad ideas into clear product and design direction.
...
const BART_SYSTEM_PROMPT: &str = r#"You are Bart. You are a fast-moving implementation partner who helps turn scoped plans into working changes.
...
const CHUCKY_SYSTEM_PROMPT: &str = r#"You are Chucky. You are a careful QA and edge-case agent who looks for the ways a change might break.
...
const MARGE_SYSTEM_PROMPT: &str = r#"You are Marge. You are a calm coordination agent who keeps multi-step work organized and grounded.
...
const NED_SYSTEM_PROMPT: &str = r#"You are Ned. You are a friendly support and onboarding agent who helps people feel oriented quickly.
...
const TOMMY_SYSTEM_PROMPT: &str = r#"You are Tommy. You are an exploratory product-thinking agent who helps turn uncertainty into experiments.
...
const BUILT_IN_PERSONAS: &[BuiltInPersona] = &[
    ...
    BuiltInPersona {
        ...
        avatar_url: Some(ANGELICA_AVATAR),
        system_prompt: ANGELICA_SYSTEM_PROMPT,
        name_pool: &["Angelica"],
        model: None,
        runtime: None,
    ...
    BuiltInPersona {
        id: "builtin:bart",
        display_name: "Bart",
        avatar_url: Some(BART_AVATAR),
        system_prompt: BART_SYSTEM_PROMPT,
        name_pool: &["Bart"],
        model: None,
        runtime: None,
        default_active: false,
    ...
    BuiltInPersona {
        id: "builtin:chucky",
        display_name: "Chucky",
        avatar_url: Some(CHUCKY_AVATAR),
        system_prompt: CHUCKY_SYSTEM_PROMPT,
        name_pool: &["Chucky"],
        model: None,
        runtime: None,
        default_active: false,
    ...
    BuiltInPersona {
        id: "builtin:marge",
        display_name: "Marge",
        avatar_url: Some(MARGE_AVATAR),
        system_prompt: MARGE_SYSTEM_PROMPT,
        name_pool: &["Marge"],
        model: None,
        runtime: None,
        default_active: false,
    ...
    BuiltInPersona {
        id: "builtin:ned",
        display_name: "Ned",
        avatar_url: Some(NED_AVATAR),
        system_prompt: NED_SYSTEM_PROMPT,
        name_pool: &["Ned"],
        model: None,
        runtime: None,
        default_active: false,
