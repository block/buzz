...
/// Read the unpredictable identity stamped on a Buzz harness generation.
/// Descendants inherit it even when they daemonize and are reparented, while
/// a later generation receives a different value.
