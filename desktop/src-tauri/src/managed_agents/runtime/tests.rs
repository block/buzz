...
fn remote_backend_status_reports_external_regardless_of_agent_id() {
    ...
    assert_eq!(
        super::remote_backend_status(&BackendKind::External, None),
        Some("external")
    );
    assert_eq!(
        super::remote_backend_status(&BackendKind::External, Some("ignored")),
        Some("external")
    );
}
...
fn remote_backend_status_tracks_provider_deploy_state() {
    ...
    assert_eq!(
        super::remote_backend_status(&provider, None),
        Some("not_deployed")
    );
    assert_eq!(
        super::remote_backend_status(&provider, Some("agent-123")),
        Some("deployed")
    );
}
