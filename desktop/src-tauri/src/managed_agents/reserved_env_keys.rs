...
pub(crate) const RESERVED_ENV_KEYS: &[&str] = &[
    ...
    // LM Studio-native policy and Command Adviser source routing are selected
    // by the trusted runtime/catalog layer and cannot be weakened by a saved,
    // persona, global, or inherited environment override.
