...
const ROW_COLUMNS: &str = "id, agent_pubkey, event_created_at, archived_at, reported_at, \
     ...
     turn_total_tokens, turn_cost_usd, turn_cache_read_tokens, cumulative_input_tokens, \
     cumulative_output_tokens, cumulative_total_tokens, cumulative_cost_usd, \
     cumulative_cache_read_tokens, parse_status";
