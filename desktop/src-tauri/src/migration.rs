...
///
/// For the pre-migration backups taken by this module's migrations before they
...
pub(super) fn create_restricted_backup_once(
    path: &Path,
    source_bytes: &[u8],
) -> Result<bool, String> {
...
///
/// [`atomic_write_json_restricted`]: crate::managed_agents::atomic_write_json_restricted
pub(super) fn resolved_backup_path(store_path: &Path, backup_name: &str) -> PathBuf {
