...
| Letta | [letta-ai/letta-acp](https://github.com/letta-ai/letta-acp) | `4b8533514092391a795671c17c1f60d118954602` | Apache-2.0 © 2025 Letta authors | `assets/icon.svg` | Dropped fixed `width` and `height`; inherited `fill="currentColor"` from the parent SVG |
