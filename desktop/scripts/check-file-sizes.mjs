...
const overrides = new Map([
  ...
  // source of the overage — production logic is ~408 lines. Queued to split
  // the test module into archive/mod_tests.rs in a follow-up.
  ["src-tauri/src/archive/mod.rs", 1289],
