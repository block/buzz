  ...
  return {
    ...
    mention: ({ children }: { children?: React.ReactNode }) => {
      ...
      const mentionNode = (
        <span
          data-mention=""
          className="cursor-pointer rounded-[4px] bg-primary/15 px-1 pt-0.5 pb-px font-semibold text-primary transition-colors hover:bg-primary/25 hover:text-primary/90"
        >
          {children}
        </span>
      );
