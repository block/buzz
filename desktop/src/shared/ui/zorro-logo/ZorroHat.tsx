/** The Zorro mark: a broad-brimmed sombrero cordobés with a Z on its crown. */
export function ZorroHat({ className }: { className?: string }) {
  return (
    <svg
      aria-hidden="true"
      className={["zorro-hat", className].filter(Boolean).join(" ")}
      viewBox="0 0 512 512"
    >
      <path
