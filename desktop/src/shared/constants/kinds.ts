...
export const CHANNEL_EVENT_KINDS = [
  ...
  KIND_JOB_REQUEST, // 43001 — signed job lifecycle
  KIND_JOB_ACCEPTED, // 43002 — signed job lifecycle
  KIND_JOB_PROGRESS, // 43003 — signed job lifecycle
  KIND_JOB_RESULT, // 43004 — signed job lifecycle
  KIND_JOB_CANCEL, // 43005 — signed job lifecycle
  KIND_JOB_ERROR, // 43006 — signed job lifecycle
