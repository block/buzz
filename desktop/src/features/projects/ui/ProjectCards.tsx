...
function RepositoryUnavailableIndicator({
  ...
  const status = {
    authentication: {
      description: "Zorro could not authenticate with this repository.",
      label: "Access failed",
    },
    missing: {
      description: "No git repository was found on the Zorro relay.",
      label: "Uninitialized",
    },
    access: {
      description:
    ...
    network: {
      description: "The Zorro git service could not be reached.",
      label: "Unreachable",
    },
    ref: {
    ...
    unknown: {
      description: "Zorro could not load this repository.",
      label: "Unavailable",
    },
  } satisfies Record<
