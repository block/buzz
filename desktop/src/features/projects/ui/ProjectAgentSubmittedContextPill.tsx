    ...
    return (
      <div className="pb-1 pl-11 pr-2" data-testid="project-agent-sent-context">
        <button
          ...
          aria-label={
            open
              ? t("projects.submitted-context-pill.hide")
              : t("projects.submitted-context-pill.show")
          }
        ...
        >
          ...
          <span>{t("projects.submitted-context-pill.label")}</span>
          <ChevronDown
        ...
        {open ? (
          <section
            aria-label={t("projects.submitted-context-pill.payload-aria")}
