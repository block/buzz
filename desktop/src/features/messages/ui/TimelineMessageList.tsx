            ...
            if (item.kind === "day-divider") {
              ...
              return (
                <div
                  ...
                  className="relative -mb-16 flex flex-col before:absolute before:inset-x-0 before:top-3.5 before:h-px before:-translate-y-1/2 before:bg-border/35 before:content-['']"
