      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate font-medium text-foreground">
            {t("messages.composer.editing-message")}
          </p>
        </div>
        {onCancelEdit ? (
          <Button
            aria-label={t("messages.composer.cancel-edit")}
  ...
  if (replyTarget) {
    return (
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate font-medium text-foreground">
            {t("messages.composer.replying-to", {
        ...
        {onCancelReply ? (
          <Button
            aria-label={t("messages.composer.cancel-reply")}
            className="-mr-1 h-7 w-7 shrink-0 px-0 text-muted-foreground hover:text-foreground"
