...
const HARNESS_DESCRIPTIONS: Record<string, string> = {
  // Built-in runtimes.
  "buzz-agent": "Mesh's built-in agent runtime, bundled with the app.",
  ...
  cursor: "Cursor's coding agent, connected to Mesh through its ACP server.",
  ...
  grok: "xAI's coding agent, connected to Mesh through its ACP entrypoint.",
