...
const HARNESS_DESCRIPTIONS: Record<string, string> = {
  // Built-in runtimes.
  "buzz-agent": "Zorro's built-in agent runtime, bundled with the app.",
  ...
  cursor: "Cursor's coding agent, connected to Zorro through its ACP server.",
  ...
  grok: "xAI's coding agent, connected to Zorro through its ACP entrypoint.",
