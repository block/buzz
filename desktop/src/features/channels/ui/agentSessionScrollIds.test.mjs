 ...
 *  tree transitively imports a .css file (ZorroLogoAnimation.tsx →
 *  zorro-logo-animation.css) and the test-loader has no CSS stub. The
...
// ZorroLogoAnimation.tsx → zorro-logo-animation.css). The test below verifies the
