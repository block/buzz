 ...
 * - claude / codex / kiro → "locked" (CLI-login runtimes; no LLM provider selection).
 ...
 * CLI-login runtimes (claude/codex/kiro) and keys satisfied by the runtime file
