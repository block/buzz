      ...
      >
          ...
          >
            ...
            >
              ...
              <input
                ...
                aria-label={t("agents.share-recipients.share-with-aria")}
                autoCapitalize="none"
                autoComplete="off"
                autoCorrect="off"
                ...
                placeholder={
                  selectedUsers.length >= RECIPIENT_LIMIT
                    ? t("agents.share-recipients.limit-reached")
                    : selectedUsers.length === 0
        ...
        >
          ...
          >
            {isSearchSettling ? (
              <div
                aria-label={t("agents.share-recipients.loading-aria")}
              ...
              visibleSearchResults.map((user) => (
                <button
                  aria-label={t("agents.share-recipients.add-aria", {
              ...
              <p className="px-3 py-3 text-sm text-muted-foreground">
                {t("agents.share-recipients.no-people")}
              </p>
            )}
          </div>
        </PopoverContent>
