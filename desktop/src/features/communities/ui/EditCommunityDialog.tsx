  ...
  return (
    <Dialog onOpenChange={onOpenChange} open={open}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>{t("communities.edit.title")}</DialogTitle>
          <DialogDescription>
            {t("communities.edit.description")}
          </DialogDescription>
        </DialogHeader>
        <form
        ...
        >
            ...
            <div className="flex items-center justify-between gap-4 rounded-xl border border-border/70 bg-muted/20 p-3">
              <div className="min-w-0">
                <p className="text-sm font-medium">
                  {t("communities.edit.icon-heading")}
                </p>
                <p className="text-xs text-muted-foreground">
                  {t("communities.edit.icon-hint")}
                </p>
              </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              {t("communities.edit.relay-label")}
            </label>
            <Input
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              {t("communities.edit.token-label")}
              <span className="ml-1 text-xs font-normal text-muted-foreground">
                {t("communities.edit.optional-suffix")}
              </span>
            </label>
            <Input
              id="edit-ws-token"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              {t("communities.edit.repos-dir-label")}
              <span className="ml-1 text-xs font-normal text-muted-foreground">
                {t("communities.edit.optional-suffix")}
              </span>
            </label>
            ...
            <p className="text-xs text-muted-foreground">
              {t("communities.edit.repos-dir-help-before")}
              <code>REPOS</code>
              {t("communities.edit.repos-dir-help-after")}
            </p>
          </div>
