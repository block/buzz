      ...
      >
        <div className="mx-auto w-full max-w-[35rem] py-14 text-left max-sm:py-6">
          ...
          >
            <div>
              <p>
                Mesh uses an identity key instead of a traditional account. It’s
                created on your device and represents you whenever you use Mesh.
              </p>
              <p>
                Your identity belongs to you, not Mesh. There’s no password to
                reset, and Mesh can’t recover your key if you lose it. Keep a
                backup somewhere safe and never share it. Anyone with your key
                can act as you.
              </p>
              <p>
                If you’re new to Mesh, create a new identity key. If you already
