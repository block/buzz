...
const BEES: Bee[] = [
  ...
  { top: "13%", left: "12%", size: 36, rotate: 18, color: ORBIT_PURPLE },
  { top: "12%", left: "73%", size: 26, rotate: -8, color: WHITE },
  { top: "18%", left: "44%", size: 24, rotate: 25, color: ORBIT_PINK },

  { top: "22%", left: "90%", size: 34, rotate: 10, color: WHITE },
  { top: "28%", left: "5%", size: 28, rotate: -18, color: ORBIT_BLUE },
  { top: "31%", left: "21%", size: 24, rotate: 8, color: YELLOW },

  { top: "35%", left: "84%", size: 32, rotate: -14, color: WHITE },
  { top: "45%", left: "13%", size: 32, rotate: 20, color: ORBIT_PURPLE },
  { top: "47%", left: "93%", size: 26, rotate: -6, color: ORBIT_PINK },
  ...
  { top: "66%", left: "88%", size: 28, rotate: -10, color: ORBIT_BLUE },
  { top: "72%", left: "48%", size: 26, rotate: 22, color: ORBIT_PURPLE },
  { top: "76%", left: "18%", size: 32, rotate: -16, color: WHITE },

  { top: "80%", left: "64%", size: 28, rotate: 8, color: ORBIT_PINK },
  { top: "86%", left: "34%", size: 34, rotate: -20, color: WHITE },
  { top: "88%", left: "80%", size: 32, rotate: 14, color: YELLOW },

  { top: "92%", left: "10%", size: 26, rotate: -8, color: ORBIT_PURPLE },
  { top: "3%", left: "42%", size: 22, rotate: 14, color: WHITE },
  { top: "9%", left: "5%", size: 24, rotate: -22, color: ORBIT_PINK },

  { top: "16%", left: "62%", size: 30, rotate: -4, color: YELLOW },
  { top: "20%", left: "30%", size: 22, rotate: 12, color: WHITE },
  { top: "26%", left: "52%", size: 26, rotate: -14, color: ORBIT_BLUE },

  { top: "33%", left: "68%", size: 22, rotate: 24, color: WHITE },
  { top: "40%", left: "40%", size: 24, rotate: -10, color: ORBIT_PURPLE },
  { top: "42%", left: "78%", size: 28, rotate: 6, color: ORBIT_PINK },
  ...
  { top: "70%", left: "76%", size: 30, rotate: 18, color: ORBIT_BLUE },
  { top: "82%", left: "6%", size: 28, rotate: 22, color: WHITE },
  { top: "84%", left: "50%", size: 24, rotate: -12, color: ORBIT_PURPLE },

  { top: "94%", left: "60%", size: 28, rotate: 16, color: ORBIT_PINK },
...
// Autonomous wander: each Orbit spark drifts on its own smooth loop.
const WANDER_X = 26;
const WANDER_Y = 20;
...
export function LandingBees() {
  ...
  React.useEffect(() => {
    ...
    const tick = (now: number) => {
      ...
      beeRefs.current.forEach((el, i) => {
        ...
        if (p) {
          const cx =
            rect.left + (rect.width * parseFloat(bee.left)) / 100;

          const cy =
            rect.top + (rect.height * parseFloat(bee.top)) / 100;
          ...
          if (dist < REPEL_RADIUS && dist > 0.01) {
            const push =
              ((REPEL_RADIUS - dist) / REPEL_RADIUS) *
              REPEL_STRENGTH;
  ...
  return (
    ...
    >
      {/* Keep existing BuzzMark component/variable structure */}
      <span className="absolute left-6 top-12 block w-14">
