...
export function CommandAdviserHero({
  ...
  return (
    ...
    >
      <div className="grid min-h-56 lg:grid-cols-[minmax(0,1.2fr)_minmax(18rem,0.8fr)]">
        <div className="flex items-center gap-4 p-5 lg:p-6">
          <img
            alt="HMAS Supply badge"
            className="h-20 w-auto shrink-0 object-contain drop-shadow-lg"
            src={hmasSupplyBadge}
          />
        ...
        <div className="relative min-h-48 border-t border-white/10 lg:min-h-56 lg:border-l lg:border-t-0">
          <img
      ...
      <div className="border-t border-white/10 bg-[#041225] p-4">
        {routingControls}
      </div>
    </section>
  );
