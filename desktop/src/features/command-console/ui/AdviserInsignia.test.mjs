...
const EXPECTED = {
  ...
  intelligence: "Maritime N2 Adviser — intelligence scan",
  logistics: "Logistics Adviser — replenishment",
...
test("renders eight distinct accessible naval adviser symbols", () => {
