...
export function MicControls({
  ...
  const micTooltip = micUnavailable
    ? t("huddle.mic.unavailable-detail")
    : micButtonLabel;
    ...
    <Popover>
      ...
      >
          ...
          <TooltipContent className="buzz-huddle-tooltip" side="top">
            {isPttMode && !micUnavailable && isEffectivelyMuted ? (
              <span className="flex items-center gap-1.5">
                <span>{t("huddle.mic.click-to-unmute")}</span>
        ...
        <PopoverTrigger asChild>
          <Button
            aria-label={t("huddle.mic.settings")}
        ...
        <div className="flex flex-col gap-3">
          <div>
            <span className="mb-1 block text-xs font-medium">
              {t("huddle.mic.input-mode")}
            </span>
            <button
              aria-label={
                isPttMode ? t("huddle.mic.ptt-off") : t("huddle.mic.ptt-on")
              }
            ...
            <span className="sr-only" aria-live="polite">
              {isPttMode
                ? t("huddle.mic.ptt-enabled")
                : t("huddle.mic.continuous")}
            </span>
          </div>
          <DeviceList
            label={t("huddle.device.microphone")}
            devices={audioDevices.map((d) => ({
              id: d.deviceId,
              label:
                d.label ||
                t("huddle.device.mic-fallback", {
    ...
    <Popover>
      <div className="relative flex items-center">
        ...
        >
          ...
          <PopoverContent
            align="center"
            aria-label={t("huddle.speaker.headphones-aria")}
            ...
            <div className="flex flex-col gap-2">
              <div>
                <p className="text-xs font-medium">
                  {t("huddle.speaker.headphones-title")}
                </p>
                <p className="mt-1 text-xs leading-snug text-foreground/75">
                  {t("huddle.speaker.headphones-body")}
                </p>
              </div>
        ...
        <Button
          aria-label={
            ttsEnabled
              ? t("huddle.speaker.mute-agent")
              : t("huddle.speaker.unmute-agent")
          }
        ...
        <PopoverTrigger asChild>
          <Button
            aria-label={t("huddle.speaker.settings")}
      ...
      <ul className="flex flex-col">
        <li>
          ...
          >
            ...
            />
            {t("huddle.device.system-default")}
          </button>
        </li>
        {keyedDevices.map((d) => {
