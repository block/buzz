...
export function SidebarProviderUsageIndicator({
  ...
  const { adapterAvailable, productLabel, query } = useProviderUsageSnapshot();
  ...
  const unsupportedMessage = adapterAvailable
    ? null
    : `${productLabel} personal allowance is unavailable`;
      ...
      <PopoverTrigger asChild>
        {compact ? (
          <ChromeUsageTrigger
            ...
            isLoading={query.isPending && adapterAvailable}
