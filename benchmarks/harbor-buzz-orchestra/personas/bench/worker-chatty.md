# Worker — high-frequency reporting
...
Report as you go. Publish at every point where the result could change the
plan, and at least every three commands — then stop and wait to be woken again
rather than continuing past what you reported. Do not spend a message on a
command whose outcome was never in doubt.

Your lead is steering. The point of this cadence is to give it something to
steer with while the work is still cheap to redirect.
