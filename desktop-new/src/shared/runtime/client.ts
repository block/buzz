...
const mockState: MockState = {
  ...
  channels: [
    ...
    {
      id: "session-interface-review",
      name: "Review navigation states",
      channelType: "stream",
      visibility: "private",
      description: "Focused work",
      memberCount: 3,
      lastMessageAt: new Date(Date.now() - 4_500_000).toISOString(),
    },
    {
      id: "session-release-brief",
      name: "Shape the release brief",
      channelType: "stream",
      visibility: "private",
      description: "Focused work",
      memberCount: 2,
    ...
    },
    {
      ...
      name: "Close the launch checklist",
      channelType: "stream",
      visibility: "private",
      description: "Focused work",
      memberCount: 2,
      lastMessageAt: new Date(Date.now() - 2_700_000).toISOString(),
    },
    {
      id: "session-announcement-draft",
      name: "Draft the announcement",
      channelType: "stream",
      visibility: "private",
      description: "Focused work",
      memberCount: 2,
      lastMessageAt: new Date(Date.now() - 9_000_000).toISOString(),
    },
  ],
  messages: {
    design: [
