...
void main() {
  group('PairingPage', () {
    testWidgets('renders branding and progressive pairing actions', (
      ...
      expect(find.byType(TappableZorroHat), findsOneWidget);
      expect(find.text('Welcome to Zorro'), findsOneWidget);
    ...
    testWidgets('uses the onboarding surface for dark-theme SAS verification', (
      ...
      expect(
        find.text(
          'Make sure the six-digit code matches on both devices. Your Zorro identity will transfer to this device. Only continue if you started this pairing from your desktop.',
        ),
        findsOneWidget,
      );
    ...
    testWidgets('recovery SAS puts permanent desktop access in the subtitle', (
      ...
      expect(find.textContaining('full Zorro identity'), findsOneWidget);
    ...
    testWidgets('keeps SAS actions above the keyboard on small screens', (
      ...
      expect(
        find.textContaining('Zorro identity will transfer'),
        findsOneWidget,
      );
      expect(find.text('Codes match'), findsOneWidget);
    });
