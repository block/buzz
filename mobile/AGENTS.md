# AGENTS.md — Mobile App (Flutter)

Read the [root AGENTS.md](../AGENTS.md) first; this file adds mobile-specific guidance.
...
[mobile/README.md](README.md) for direct Xcode / Android Studio
usage.
