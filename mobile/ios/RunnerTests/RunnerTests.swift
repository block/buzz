...
class RunnerTests: XCTestCase {
  ...
  func testDynamicIslandQrScannerRecognizesSupportedIPhones() {
  ...
  func testDynamicIslandQrScannerRejectsUnsupportedDevices() {
    for modelIdentifier in [
      "iPhone14,7", "iPhone14,8", "iPhone17,5", "iPhone18,5",
      "iPad16,3", "arm64",
    ] {
      XCTAssertFalse(
        AppDelegate.usesDynamicIslandQrScannerPortal(
