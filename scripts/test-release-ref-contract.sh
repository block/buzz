...
grep -Fq 'gh pr list --repo SaledaAI/saleda-buzz' "$repo_root/scripts/prepare-desktop-release.sh"
grep -Fq 'gh pr edit --repo SaledaAI/saleda-buzz' "$repo_root/scripts/prepare-desktop-release.sh"
grep -Fq 'gh pr create --repo SaledaAI/saleda-buzz' "$repo_root/scripts/prepare-desktop-release.sh"
