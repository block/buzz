...
[[ "$repo" == "SaledaAI/saleda-buzz" ]] || fail "candidate publishing is restricted to SaledaAI/saleda-buzz"
...
message="Zorro Mobile $version release candidate $candidate_number"
tag_object_sha="$(
